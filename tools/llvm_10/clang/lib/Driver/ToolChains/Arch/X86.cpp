...
void x86::getX86TargetFeatures(const Driver &D, const llvm::Triple &Triple,
  ...
  auto Ret2SpecOpt = clang::driver::options::ID::OPT_INVALID;
  if (Args.hasFlag(options::OPT_mret_spec, options::OPT_mno_ret_spec, false)) {
    Features.push_back("+ret-spec");
    Ret2SpecOpt = options::OPT_mret_spec;
  }

  // TODO LET retpolines and LVI work together
  /*
