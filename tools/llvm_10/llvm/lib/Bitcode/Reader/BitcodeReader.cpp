...
static uint64_t getRawAttributeMask(Attribute::AttrKind Val) {
  ...
  case Attribute::NoLviRet:        return 3;
  case Attribute::NoLviIcall:      return 3 << 1;
...
static Attribute::AttrKind getAttrFromCode(uint64_t Code) {
  ...
  case bitc::ATTR_KIND_NOLVIRET:
    return Attribute::NoLviRet;
  case bitc::ATTR_KIND_NOLVIICALL:
    return Attribute::NoLviIcall;
  }
}
